...
public class HttpClientUtil {
	 ...
	 */
	private RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(600000)
	...
	public String sendHttpPost(String httpUrl, String params) {
		...
		try {
			...
			stringEntity.setContentType("application/x-www-form-urlencoded");//post默认的请求方式
